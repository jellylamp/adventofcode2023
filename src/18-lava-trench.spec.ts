...
// U 2 (#7a21e3)`;
//
//   const lavaTrench = new LavaTrench(input);
//   expect(lavaTrench.filledSqFt).toEqual(62);
// });

test("Day 18 puzzle input sample", () => {
  const input = `L 4 (#0527c0)
U 6 (#3bb5c3)
L 3 (#916d22)
U 4 (#504aa3)
L 3 (#916d20)
...
U 5 (#13c5c3)`;
  ...
  const lavaTrench = new LavaTrench(input);
  expect(lavaTrench.filledSqFt).toEqual(36725);
});
