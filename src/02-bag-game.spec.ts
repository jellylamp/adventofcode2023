...
import {BagGame} from "./02-bag-game";
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`;
  ...
  const bagGameOutput = new BagGame(input);
  expect(bagGameOutput.totalIdCount).toEqual(8);
});

test("Day 2 puzzle a input sample", () => {
  const input = `Game 1: 1 red, 3 blue, 11 green; 1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green
...
Game 100: 16 blue, 12 red, 3 green; 2 green, 7 blue; 5 blue, 4 green; 10 blue, 6 red, 6 green; 5 red, 12 blue, 2 green; 9 red, 12 blue, 11 green`;
  ...
  const bagGameOutput = new BagGame(input);
  expect(bagGameOutput.totalIdCount).toEqual(1931);
  expect(bagGameOutput.totalPowerOfGames).toEqual(83105);
});
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`;
  ...
  const bagGameOutput = new BagGame(input);
  expect(bagGameOutput.totalPowerOfGames).toEqual(2286);
});