...
test("Day 3 puzzle a edge case: example 6", () => {
  const input =
`
$11
...
...
`;
  ...
  expect(enginePartsOutput.gearTotalCount).toEqual(84900879);
});


test("Day 3 puzzle edge case: handle symbol . number number number", () => {
  const input = `
....692*............177........................727..364..800.......................748..../........*...........%733......993.854........+...
...........*..............245..........128.............*.................322......................305....7*.......................152.......
........978.160..378.........*524.......*..905.343..+.681......615......-..........................................$..........@.............
...
`;
  ...
  const enginePartsOutput = new EngineParts(input);
  expect(enginePartsOutput.totalCount).toEqual(10423);
  expect(enginePartsOutput.gearTotalCount).toEqual(941139);
});

test("Day 3 puzzle edge case part b chunks - neighbors were duplicated already", () => {
  const input = `
..........................................389.314.................206......................449.523..................138.....................
.........+.....954......723..........................................*.............687.....*..........692..........*........................
121......992...............*.......%585....814............936.......102..#353.........*.....140.........*..434..301..................%..315.
...
`;
  const enginePartsOutput = new EngineParts(input);
  expect(enginePartsOutput.gearTotalCount).toEqual(5214174);
});
