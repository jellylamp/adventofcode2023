...
{x=2127,m=1623,a=2188,s=1013}`;
  ...
  const gearSorting = new GearSorting(input);
  expect(gearSorting.acceptedSum).toEqual(19114);
});

test("Day 19 puzzle input sample", () => {
  const input = `hfm{a<1891:R,m<2881:A,m<2987:A,R}
...
{x=229,m=152,a=753,s=285}`;
  ...
  const gearSorting = new GearSorting(input);
  expect(gearSorting.acceptedSum).toEqual(472630);
});